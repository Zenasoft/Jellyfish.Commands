...
namespace Jellyfish.Commands.Tests
{
    public class RollingPercentileTest
    {
        ...
        private static int timeInMilliseconds = 60000;
        private static int numberOfBuckets = 12; // 12 buckets at 5000ms each
        private static int bucketDataLength = 1000;
        private static IDynamicProperty<Boolean> enabled = DynamicProperties.Factory.AsProperty(true);
        ...
        //    {
        //        Console.WriteLine("Thread pool never terminated in RollingPercentileTest");
        //    }
        //}
        ...
        public void testPercentileAlgorithm_Extremes()
        {
            ...
            //Console.WriteLine("0.01: " + p.GetPercentile(0.01));
            //Console.WriteLine("10th: " + p.GetPercentile(10));
            //Console.WriteLine("Median: " + p.GetPercentile(50));
            //Console.WriteLine("75th: " + p.GetPercentile(75));
            //Console.WriteLine("90th: " + p.GetPercentile(90));
            //Console.WriteLine("99th: " + p.GetPercentile(99));
            //Console.WriteLine("99.5th: " + p.GetPercentile(99.5));
            //Console.WriteLine("99.99: " + p.GetPercentile(99.99));
            ...
            {
                throw new Exception("We expect the 90th to be over 600 to show the extremes but got: " + p.GetPercentile(90));
            }
            if (p.GetPercentile(99) < 600)
            {
                throw new Exception("We expect the 99th to be over 600 to show the extremes but got: " + p.GetPercentile(99));
            }
        }
        ...
        //    MockedClock time = new MockedClock();
        //    int previousTime = 0;
        //    RollingPercentileNumber p = new RollingPercentileNumber(time, timeInMilliseconds, numberOfBuckets, bucketDataLength);
...
private static class SampleDataHolder1
        ...
        private static class SampleDataHolder2
        {
             ...
             * Array of [milliseconds, latency]
             */
            public static int[,] data = new int[,] { { 0, 3 }, { 43, 33 }, { 45, 11 }, { 45, 1 }, { 68, 13 }, { 88, 10 }, { 158, 68 }, { 158, 4 }, { 169, 168 }, { 267, 68 }, { 342, 68 }, { 438, 68 }, { 464, 7 }, { 504, 68 }, { 541, 6 }, { 541, 68 }, { 562, 68 }, { 581, 3 }, { 636, 68 }, { 778, 68 }, { 825, 1 }, { 859, 68 },
